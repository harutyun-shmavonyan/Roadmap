...
public record ScheduleBlockDto(
    ...
    /// <summary>Weighted sprints only: today's price as a percent of the item's nominal
    /// rate — 112 means a unit is worth 12% more than usual today, 92 less, 100 neutral.</summary>
