...
export interface ArticleDto { id: string; title: string; format: ArticleFormat; content: string; readMinutes: number; isRead: boolean; readOn: string | null; sortOrder: number; images: ArticleImageDto[]; chatUrl: string | null; readProgress: number; createdAt: string; updatedAt: string; }
