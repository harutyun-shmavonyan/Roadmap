...
export const NAV_ICON: Record<string, ReactNode> = {
  ...
  weekplan: (
    <S>
      <rect x="2.5" y="5.5" width="19" height="14" rx="3" fill="#6366f1" />
  ...
  roadmap: (
    <S>
      ...
      <circle cx="7" cy="4.5" r="2.8" fill="#22c55e" />
      <circle cx="16.5" cy="10" r="2.6" fill="#22c55e" />
      <circle cx="16.5" cy="18" r="2.6" fill="#22c55e" />
    </S>
  ),
  // Tasks — a clipboard with one thing done.
  tasks: (
    <S>
      <rect x="4" y="4" width="16" height="17" rx="3" fill="#f59e0b" />
  ...
  articles: (
    <S>
      <path d="M3 5.5h6.2c1.6 0 2.8.9 2.8 2.1V20c0-1-1.2-1.8-2.8-1.8H3z" fill="#fb923c" />
  ...
  english: (
    <S>
      <path d="M4 5.5h16a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-8.5L7 21v-4.5H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2z" fill="#06b6d4" />
  ...
  notes: (
    <S>
      <rect x="4" y="3" width="14" height="18" rx="2.5" fill="#84cc16" />
  ...
  nutrition: (
    <S>
      <path d="M12 7c-1-.8-2.2-1.2-3.4-1.2C5.9 5.8 4 8.2 4 11.6c0 3.8 2.6 9.4 5.3 9.4 1 0 1.7-.5 2.7-.5s1.7.5 2.7.5c2.7 0 5.3-5.6 5.3-9.4 0-3.4-1.9-5.8-4.6-5.8-1.2 0-2.4.4-3.4 1.2z" fill="#ef4444" />
  ...
  jobs: (
    <S>
      <rect x="2.5" y="7" width="19" height="13" rx="2.5" fill="#a16207" />
